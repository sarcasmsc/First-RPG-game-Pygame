...
class Rodent(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.rodent_spritesheet.get_sprite(36, 29, self.width, self.height)
        ...
        self.left_animations = [self.game.rodent_spritesheet.get_sprite(36, 29, self.width, self.height)]

        self.right_animations = [self.game.rodent2_spritesheet.get_sprite(30, 29, self.width, self.height)]
    ...
    def animate(self):
        ...
        if self.facing == "left":
            if self.x_change == 0:
                ...
                self.image = self.game.rodent2_spritesheet.get_sprite(30, 29, self.width, self.height)
                self.animation_loop += 0.1
                if self.animation_loop >= 3:
                    self.animation_loop = 0
